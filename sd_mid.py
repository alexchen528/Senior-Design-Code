    ...
    for j in range(1, 13):
        ...
        for k in range(32):
            ...
            try:
                ...
                index_list = np.where((data["std_recon"]["energy"] >= 7.943282) & (data["std_recon"]["energy"] < 39.81071) & (data["std_recon"]["nstclust"] > 5))[0]
...
# plt.xlabel('Time(μs)')
# plt.ylabel('Frequency')
# plt.savefig("Arrival_SD_MID.png")
# plt.close()
...
# plt.ylabel('Frequency')
# plt.yscale("log")
# plt.savefig("Arrival_SD_MID_LOG.png")
# plt.close()
...
plt.savefig("Duration_SD_MID.png")
plt.close()
...
plt.ylabel('Frequency')
plt.yscale("log")
plt.savefig("Duration_SD_MID_LOG.png")
plt.close()
...
np.savez("/ceph/work/SATORI/projects/TA-ASIoP/sd_waveform/sd_mid.npz", 
...
# plt.savefig("Lateral_Distance_SD_MID.png")
# plt.close()
...
# plt.yscale("log")
# plt.savefig("Lateral_Distance_SD_MID_LOG.png")
# plt.close()
