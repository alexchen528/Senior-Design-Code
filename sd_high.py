    ...
    for j in range(1, 13):
        ...
        for k in range(32):
            ...
            try:
                ...
                index_list = np.where((data["std_recon"]["energy"] >= 50.11872) & (data["std_recon"]["energy"] < 316.2278) & (data["std_recon"]["nstclust"] > 5))[0]
...
# plt.xlabel('Time(μs)')
# plt.ylabel('Frequency')
# plt.savefig("Arrival_SD_HIGH.png")
# plt.close()
...
# plt.ylabel('Frequency')
# plt.yscale("log")
# plt.savefig("Arrival_SD_HIGH_LOG.png")
# plt.close()
...
plt.savefig("Duration_SD_HIGH.png")
plt.close()
...
plt.ylabel('Frequency')
plt.yscale("log")
plt.savefig("Duration_SD_HIGH_LOG.png")
plt.close()
...
np.savez("/ceph/work/SATORI/projects/TA-ASIoP/sd_waveform/sd_high.npz", 
...
# plt.savefig("Lateral_Distance_SD_HIGH.png")
# plt.close()
...
# plt.yscale("log")
# plt.savefig("Lateral_Distance_SD_HIGH_LOG.png")
# plt.close()
