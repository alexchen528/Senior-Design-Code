...
sd_low_en = np.load("xxxxxxx/sd_waveform/sd_low.npz")
sd_mid_en = np.load("xxxxxxx/sd_waveform/sd_mid.npz")
sd_high_en = np.load("xxxxxx/sd_waveform/sd_high.npz")
pro_low_en = np.load("xxxxxx/sd_waveform/proton_low.npz")
pro_mid_en = np.load("xxxxxx/sd_waveform/proton_mid.npz")
pro_high_en = np.load("xxxxxx/sd_waveform/proton_high.npz")
iro_low_en = np.load("xxxxxxx/sd_waveform/iron_low.npz")
iro_mid_en = np.load("xxxxxx/sd_waveform/iron_mid.npz")
iro_high_en = np.load("xxxxxx/sd_waveform/iron_high.npz")
