...
# plt.xlabel('Time(μs)')
# plt.ylabel('Frequency')
# plt.savefig("Arrival_IRON_LOW.png")
# plt.close()
...
# plt.ylabel('Frequency')
# plt.yscale("log")
# plt.savefig("Arrival_IRON_LOW_LOG.png")
# plt.close()
...
plt.savefig("Duration_IRON_LOW.png")
plt.close()
...
plt.ylabel('Frequency')
plt.yscale("log")
plt.savefig("Duration_IRON_LOW_LOG.png")
plt.close()
...
np.savez("/ceph/work/SATORI/projects/TA-ASIoP/sd_waveform/iron_low.npz", 
...
# plt.savefig("Lateral_Distance_IRON_LOW.png")
# plt.close()
...
# plt.yscale("log")
# plt.savefig("Lateral_Distance_IRON_LOW_LOG.png")
# plt.close()
