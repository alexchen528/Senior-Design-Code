...
# plt.xlabel('Time(μs)')
# plt.ylabel('Frequency')
# plt.savefig("Arrival_IRON_HIGH.png")
# plt.close()
...
# plt.ylabel('Frequency')
# plt.yscale("log")
# plt.savefig("Arrival_IRON_HIGH_LOG.png")
# plt.close()
...
plt.savefig("Duration_IRON_HIGH.png")
plt.close()
...
plt.ylabel('Frequency')
plt.yscale("log")
plt.savefig("Duration_IRON_HIGH_LOG.png")
plt.close()
...
np.savez("/ceph/work/SATORI/projects/TA-ASIoP/sd_waveform/iron_high.npz", 
...
# plt.figure(figsize=(15, 15))
# plt.subplot(2, 2, 1)
# # plt.errorbar(centers_up_prior, counts_up_prior/areas_log_up_prior,yerr= np.sqrt(counts_up_prior)/areas_log_up_prior, fmt='rs')
...
# plt.savefig("Lateral_Distance_IRON_HIGH.png")
# plt.close()
...
# plt.yscale("log")
# plt.savefig("Lateral_Distance_IRON_HIGH_LOG.png")
# plt.close()
