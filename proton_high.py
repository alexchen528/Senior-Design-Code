...
# plt.xlabel('Time(μs)')
# plt.ylabel('Frequency')
# plt.savefig("Arrival_PRO_HIGH.png")
# plt.close()
...
# plt.ylabel('Frequency')
# plt.yscale("log")
# plt.savefig("Arrival_PRO_HIGH_LOG.png")
# plt.close()
...
plt.savefig("Duration_PRO_HIGH.png")
plt.close()
...
plt.ylabel('Frequency')
plt.yscale("log")
plt.savefig("Duration_PRO_HIGH_LOG.png")
plt.close()
...
np.savez("/ceph/work/SATORI/projects/TA-ASIoP/sd_waveform/proton_high.npz", 
...
# plt.savefig("Lateral_Distance_PRO_HIGH.png")
# plt.close()
...
# plt.yscale("log")
# plt.savefig("Lateral_Distance_PRO_HIGH_LOG.png")
# plt.close()
