...
# plt.xlabel('Time(μs)')
# plt.ylabel('Frequency')
# plt.savefig("Arrival_PRO_MID.png")
# plt.close()
...
# plt.ylabel('Frequency')
# plt.yscale("log")
# plt.savefig("Arrival_PRO_MID_LOG.png")
# plt.close()
...
plt.savefig("Duration_PRO_MID.png")
plt.close()
...
plt.ylabel('Frequency')
plt.yscale("log")
plt.savefig("Duration_PRO_MID_LOG.png")
plt.close()
...
np.savez("/ceph/work/SATORI/projects/TA-ASIoP/sd_waveform/proton_mid.npz", 
...
# plt.savefig("Lateral_Distance_PRO_MID.png")
# plt.close()
...
# plt.yscale("log")
# plt.savefig("Lateral_Distance_PRO_MID_LOG.png")
# plt.close()
